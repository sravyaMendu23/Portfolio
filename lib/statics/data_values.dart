class DataValues {
   ...
   static const String headerTitle = 'Mobile App Developer | Flutter & Dart';
   ...
   static const String aboutMeDescription =
       'I’m Sravya Mendu, a passionate Flutter developer with experience in creating high-quality mobile apps. This portfolio highlights my background, education, skills, and work experience.';
   static const String aboutMeBiographyTitle = 'Biography';
   static const String aboutMeBiographyDescription =
       'Hi there! I\'m a Android and solution developer. I believe in always learning and growing, and I try to apply new knowledge to everything I do.';
   ...
   static const String projectsOrg1Duration = 'Mar 2022 – Sep 2022';
   static const String projectsOrg1Technologies = 'Kotlin, XML and Firebase';
   static const String projectsOrg1Aim = 'An Android-based mobile application designed to connect doctors and patients through a seamless online consultation platform. The app enables easy appointment booking, real-time communication, and remote access to healthcare services. Developed with a focus on accessibility, user-friendly design, and efficient virtual healthcare delivery.';

   //Projects2
   static const String projectsOrg2Title = 'Card Issuance';
   static const String projectsOrg2Duration = 'April 2023 – Present';
   static const String projectsOrg2Technologies = 'Flutter, Dart, REST APIs, JSON and GitHub';
   static const String projectsOrg2Aim = 'Developed a secure and scalable mobile banking app offering end-to-end payment solutions, including digital wallet integration and modernized payment switch support. Enabled fast onboarding for all card types and full card lifecycle management. Seamlessly integrated with core banking systems and national payment infrastructures to deliver a modern, compliant, and high-performance card experience across Android and iOS.';
