class DataValues {
  ...
  static const String headerTitle = 'Flutter | Android Developer';
  ...
  static const String aboutMeDescription =
      'I’m Sravya Mendu, a passionate Flutter developer with experience in creating high-quality mobile apps. This profile highlights my background, education, skills, and work experience. Feel free to reach out for more information.';
  static const String aboutMeBiographyTitle = 'Biography';
  static const String aboutMeBiographyDescription =
      'Hi there! I\'m a solution developer. I believe in always learning and growing, and I try to apply new knowledge to everything I do.';
  ...
  static const String educationDescription =
      'My educational background is not specific in any particular way and has come from various places. Here, you can find out about my formal and other sources . So, here are my school, undergraduate institution, and other learning platforms that I\'ve been involving for education.';
  ...
  //Projects1
  static const String projectsOrg1Title = 'HOMEODOCTOR';
  static const String projectsOrg1Tech = 'Kotlin, XML and Firebase';
  static const String projectsOrg1Years = 'Mar 2022 - Sep 2022';
  static const String projectsOrg1Aim =
      'Developed an Android-based application that provides an online platform connecting doctors with patients. The app enables users to easily schedule appointments, consult with doctors remotely, and access medical services through a convenient and user-friendly interface.';

  //Projects2
  static const String projectsOrg2Title = 'CARD ISSUANCE';
  static const String projectsOrg2Tech =
      'Android, Flutter, Dart, REST API and JSON Parsing.';
  static const String projectsOrg2Years = 'April 2023 - Present';
  static const String projectsOrg2Aim =
      'Developed a secure and scalable cross-platform mobile banking app offering end-to-end payment solutions, including digital wallet integration and modernized payment switch support. Enabled fast onboarding for all card types and full card lifecycle management. Seamlessly integrated with core banking systems and national payment infrastructures to deliver a modern, compliant, and high-performance card experience across Android and iOS.';

  // Contact
  static const String contactTitle = 'Contact';
  static const String contactDescription =
      'Hey! Feel free to explore more on my social and professional platforms linked below. I welcome you to connect and explore my work further.';
  ...
  static const String copyright =
      "Copyright ©2025 Sravya Mendu. All Rights Reserved.";
}
